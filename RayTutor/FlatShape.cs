namespace RayTutor
{
    class FlatShape : GeometricObject
    {
        ...
        private FlatShape(Vector3 anyPoint, Vector3 normal, IMaterial mat)
        {
            this.point = anyPoint;
            this.normal = normal;
        ...
        public static FlatShape Triangle(Vector3 a, Vector3 b, Vector3 c, IMaterial mat)
        {
            Vector3 normal = Vector3.Cross((b - a), (c - a)).Normalized;

            FlatShape result = new FlatShape(a, normal, mat);
